...
type motionproops = ImageProps & MotionProps & {};

const MotionImage = forwardRef<HTMLDivElement, motionproops>((props, ref) => (
  <motion.div
    ref={ref}
    ...
    <div className="relative bg-bgcolor min-h-[700px] max-xl:min-h-[661px] max-lg:static ">
      <div className="flex max-xl:flex-col-reverse max-xl:px-5 absolute z-20 max-lg:static ">
        <motion.div
          ...
          className="flex  max-xl:*:mx-[2px] mt-24 max-xl:mx-auto xl:ml-6 max-xl:items-center flex-col max-xl:flex-col-reverse  max-xl:-mt-6   items-center w-[15px]  "
        >
